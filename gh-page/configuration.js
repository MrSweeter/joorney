...
export const features = [
    ...
    },
    {
        ...
        additionalDescription: `<div class="additional-info">
            <p class="fw-bold">Additional Information:</p>
            <ul>
                <li class="pb-3"><strong>Visual Feedback:</strong> Adds a visually pleasing stars particle effect when prioritizing tasks.</li>
                <li class="pb-3"><strong>Engaging Experience:</strong> Makes task prioritization more enjoyable and interactive.</li>
                <li class="pb-3"><strong>Instant Recognition:</strong> Provides immediate visual confirmation when a task is prioritized.</li>
